...
export const PersonaReveal: React.FC<PersonaRevealProps> = ({ 
  ...
  const { imageUrl, traits, memories, secrets, revealProgress, chemistry, drunkFactor, isGenerating } = persona;
        ...
        >
            ...
            <section>
              ...
              <div className="space-y-4">
                {secrets.length > 0 ? secrets.map((s, i) => (
                  ...
                  <p className="text-[10px] text-white/10 uppercase tracking-[0.3em] text-center py-8 border border-dashed border-white/5 rounded-3xl">Undisclosed</p>
                )}
              </div>
            </section>
          </div>
          ...
          <div className="grid grid-cols-2 gap-5 mt-10">
            <div className="p-6 bg-white/[0.02] border border-white/5 rounded-[36px] text-center shadow-inner">
              <span className="text-[9px] text-white/30 uppercase font-black block mb-1 tracking-[0.3em]">Haze</span>
              <span className="text-3xl font-serif text-amber-500/80">{drunkFactor}<span className="text-sm opacity-30 ml-1">/5</span></span>
            </div>
            <div className="p-6 bg-white/[0.02] border border-white/5 rounded-[36px] text-center shadow-inner">
